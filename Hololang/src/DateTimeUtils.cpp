...
String FormatDate(time_t t, String formatSpec) {
	...
	} else if (formatSpec == "G") { 
		strftime(buffer, BUFSIZE, "%x %X", &dateTime);
		return buffer;
	} else if (formatSpec == "M" or formatSpec == "m") {	
		formatSpec = "d MMMM";
	} else if (formatSpec == "O" or formatSpec == "o") {	
		formatSpec = "yyyy'-'MM'-'dd'T'HH':'mm':'ss'.'fffffffK";
	} else if (formatSpec == "R" or formatSpec == "r") {	
		formatSpec = "ddd, dd MMM yyyy HH':'mm':'ss 'GMT'";
	} else if (formatSpec == "s") {	
		formatSpec = "yyyy'-'MM'-'dd'T'HH':'mm':'ss";
	} else if (formatSpec == "t") { 
		formatSpec = "HH:mm";
	} else if (formatSpec == "T") { 
		formatSpec = "HH:mm:ss";
	} else if (formatSpec == "u") { 
		formatSpec = "yyyy'-'MM'-'dd HH':'mm':'ss'Z'";
	} else if (formatSpec == "U") { 
		formatSpec = "dddd, dd MMMM yyyy HH:mm:ss";
	} else if (formatSpec == "Y" or formatSpec == "y") {	
