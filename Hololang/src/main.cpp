...
#include "Hololang/UnicodeUtil.h"
#include "Hololang/UnitTest.h"
#include "Hololang/SimpleVector.h"
#include "Hololang/List.h"
#include "Hololang/Dictionary.h"
#include "Hololang/HololangParser.h"
#include "Hololang/HololangInterpreter.h"
#include "OstreamSupport.h"
#include "Hololang/SplitJoin.h"
...
static void PrintHeaderInfo() {
	...
	std::cout << "Hololang " << std::endl
	<< Hololang::hostName << " v" << Hololang::hostVersion
	<< "; language v" << VERSION;
#if(DEBUG)
	std::cout << " (DEBUG)";
#endif
...
//	std::cout << "Running test starting at line " << sourceLineNum << std::endl;
	...
	testOutput.Clear();
	{
		Interpreter hololang(sourceLines);
		hololang.standardOutput = &PrintToTestOutput;
		hololang.errorOutput = &PrintToTestOutput;
		hololang.implicitOutput = &PrintToTestOutput;
		hololang.RunUntilDone(60, false);
	}
...
int main(int argc, const char * argv[]) {
	...
	Hololang::hostVersion = 1.3;
#if _WIN32 || _WIN64
	Hololang::hostName = "Command-Line (Windows)";
#elif defined(__APPLE__) || defined(__FreeBSD__)
	Hololang::hostName = "Command-Line (Unix)";
#else
	Hololang::hostName = "Command-Line (Linux)";
#endif
	Hololang::hostInfo = "";
